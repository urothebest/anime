...
getgenv().waitUntilCollect = 0.9 --Change this if ur getting kicked a lot
...
getgenv().webhook = "https://discord.com/api/webhooks/1306354413899612252/rEDG_9hvOmhI-oyu-8l5_ZbQC3Io-vXJ14l-eIJQ82mOw3lnQ0EqQliyz0NI3pxfysnw" --change this if u want to use ur own webhook
...
local function autoStory()
    ...
    elseif questPanel:FindFirstChild("Take down 3 vampires") and LocalPlayer.PlayerStats.Spec.Value ~= "None" then
